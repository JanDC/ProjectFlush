    ...
    <meta charset="utf-8" />
        ...
        <!--[if lt IE 9]>
            ...
            <body>
                ...
                <div id="container" class="clearfix">
                    <div id="heren">
                        ...
                        if ($brightnessM > 0) {
                            echo 'ocupado <div class="time">' . $timeM->format("H:i") . ' due '.$dueM.' </div>';
                        } else {
                            echo 'libre';
                        }
                        ?></div>
                    ...
                    <div id="dames">
                        ...
                        <div class="status"><?php
                        if ($brightnessV > 0) {
                            echo 'ocupado <div class="time">' . $timeV->format("H:i") .' due '.$dueV. '</div>';
                        } else {
                            echo 'libre';
                        }
                        ?></div>
           ...
           if(data[0][1].state=="0" && man_bezet == 1){
            ...
            $('#heren .status').html("ocupado<div class=\"time\">"+data[0][1].timestamp+" due "+data[0][1].due+"</div>");
            man_bezet = 1;
        }
		    //set ladystate
            if(data[0][0].state=="0" && vrouw_bezet == 1){
                ...
                $('#dames .status').html("ocupado<div class=\"time\">"+data[0][0].timestamp+" due "+data[0][0].due+"</div>");
                vrouw_bezet = 1;
            }
